export default {
  route: {
    ...
    market:"market",//销售管理
    demand:"demand",
    myPersonal:'myPersonal',//HR管理
    nowDemand:"nowDemand",//最新需求
    notConner:"notConner",//暂未接通
    touJd:"touJd",//投递管理
    articleEdit:'articleEdit',//审核管理
    dataImport:`dataImport`,
    resource:"resource",//RPO管理
    rpoProject:"rpoProject",//RPO项目管理
    rpoJd:"rpoJd",//RPO公海简历
    Jurisdiction:"Jurisdiction",              // 权限管理
